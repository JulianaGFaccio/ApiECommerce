...
namespace ApiECommerce.Migrations
{
    ...
    [Migration("20241211012928_MigracaoInicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiECormmerce.Entities.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiECormmerce.Entities.DetalhePedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiECormmerce.Entities.ItemCarrinhoCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiECormmerce.Entities.Pedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiECormmerce.Entities.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiECormmerce.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiECormmerce.Entities.DetalhePedido", b =>
                {
                    b.HasOne("ApiECormmerce.Entities.Pedido", "Pedido")
                        .WithMany("DetalhesPedidos")
                        .HasForeignKey("PedidoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiECormmerce.Entities.Produto", "Produto")
            ...
            modelBuilder.Entity("ApiECormmerce.Entities.ItemCarrinhoCompra", b =>
                {
                    b.HasOne("ApiECormmerce.Entities.Produto", null)
            ...
            modelBuilder.Entity("ApiECormmerce.Entities.Pedido", b =>
                {
                    b.HasOne("ApiECormmerce.Entities.Usuario", null)
                        .WithMany("Pedidos")
            ...
            modelBuilder.Entity("ApiECormmerce.Entities.Produto", b =>
                {
                    b.HasOne("ApiECormmerce.Entities.Categoria", null)
                        .WithMany("Produtos")
